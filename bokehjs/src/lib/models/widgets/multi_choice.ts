...
function choices_class(Base: typeof Choices): typeof Choices {
  return class OurChoices extends Base {
...
export class MultiChoiceView extends InputWidgetView {
  ...
  override async lazy_initialize(): Promise<void> {
    ...
    this._Choices = choices_class(Choices)
  }
...
export class MultiChoice extends InputWidget {
  ...
  protected constructor(attrs?: Partial<MultiChoice.Attrs>) {
    super(attrs)
  }
