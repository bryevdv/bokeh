...
.. bokeh-embed:: __REPO__/examples/basic/bars/basic.py
...
.. bokeh-embed:: __REPO__/examples/basic/bars/sorted.py
    :source-position: above
...
* Supply all the colors along with the rest of the data to
  ...
  .. bokeh-embed:: __REPO__/examples/basic/bars/colors.py
    :source-position: above
...
* Use the ``CategoricalColorMapper`` model to map bar colors in a browser.
  ...
  .. bokeh-embed:: __REPO__/examples/basic/bars/colormapped.py
    :source-position: above
...
.. bokeh-embed:: __REPO__/examples/basic/bars/stacked.py
    :source-position: above

You can also stack bars that represent positive and negative values:

.. bokeh-embed:: __REPO__/examples/basic/bars/stacked_split.py
    :source-position: above
...
.. bokeh-embed:: __REPO__/examples/basic/bars/stacked_hover.py
    :source-position: above
...
.. bokeh-embed:: __REPO__/examples/basic/bars/nested.py
    :source-position: above
...
.. bokeh-embed:: __REPO__/examples/basic/bars/nested_colormapped.py
...
.. bokeh-embed:: __REPO__/examples/basic/bars/dodged.py
    :source-position: above
...
.. bokeh-embed:: __REPO__/examples/basic/bars/stacked_grouped.py
    :source-position: above
...
.. bokeh-embed:: __REPO__/examples/basic/bars/mixed.py
    :source-position: above
...
.. bokeh-embed:: __REPO__/examples/basic/bars/pandas_groupby_colormapped.py
    :source-position: above
...
.. bokeh-embed:: __REPO__/examples/basic/bars/pandas_groupby_nested.py
    :source-position: above
...
.. bokeh-embed:: __REPO__/examples/basic/bars/intervals.py
    :source-position: above
