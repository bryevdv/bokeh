...
.. bokeh-embed:: __REPO__/examples/topics/stats/histogram.py
...
.. bokeh-embed:: __REPO__/examples/topics/stats/pyramid.py
    :source-position: above
...
.. bokeh-embed:: __REPO__/examples/topics/stats/boxplot.py
    :source-position: above
...
.. bokeh-embed:: __REPO__/examples/topics/stats/kde2d.py
    :source-position: above

Kernel density estimates can also be plotted using |varea| glyphs:

.. bokeh-embed:: __REPO__/examples/topics/stats/density.py
    :source-position: above
...
.. bokeh-embed:: __REPO__/examples/topics/stats/sinaplot.py
    :source-position: above
...
.. bokeh-embed:: __REPO__/examples/topics/stats/splom.py
    :source-position: above
