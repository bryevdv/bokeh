...
.. bokeh-embed:: __REPO__/examples/styling/visuals/visible_property.py
    :source-position: above

This can be particularly useful in interactive examples with a Bokeh server or
CustomJS.

.. bokeh-embed:: __REPO__/examples/styling/visuals/visible_annotation_with_interaction.py
    :source-position: above
...
.. bokeh-embed:: __REPO__/examples/styling/visuals/specifying_colors.py
    :source-position: above
...
.. bokeh-embed:: __REPO__/examples/styling/visuals/specifying_colors_properties.py
