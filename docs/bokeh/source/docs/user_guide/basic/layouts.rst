...
.. bokeh-embed:: __REPO__/examples/basic/layouts/vertical.py
...
.. bokeh-embed:: __REPO__/examples/basic/layouts/horizontal.py
    :source-position: above
...
.. bokeh-embed:: __REPO__/examples/basic/layouts/grid.py
    :source-position: above
...
.. bokeh-embed:: __REPO__/examples/basic/layouts/grid_convenient.py
    :source-position: above
...
.. bokeh-embed:: __REPO__/examples/basic/layouts/sizing_mode.py
...
.. bokeh-embed:: __REPO__/examples/basic/layouts/sizing_mode_multiple.py
    :source-position: none
